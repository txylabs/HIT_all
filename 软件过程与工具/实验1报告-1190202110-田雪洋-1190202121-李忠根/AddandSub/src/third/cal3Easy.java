...
public class cal3Easy extends JFrame {
...
//	}
	...
	public cal3Easy() {
		...
		Operator.setBounds(77, 280, 45, 44);
		...
		Start.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(Math.random()>0.5) {
					Operator.setText("+");
					CalProcessEasy a = new CalProcessEasy();
